        ...
        let cardData : Array<Array<cardType>> = [
            [
                ...
                },
                {
                    ...
                    description: "",
                    tags: ['Dev', 'Launch', 'Project'],
                    owner : ""
                },
                {
                    text : "Weekly Updates",
                    description: "Team and project news.",
                    tags: [],
                    owner : ""
                }
            ],
            ...
            [
                ...
                {
                    text : "Finished",
                    description: "Just include tasks that was finished",
                    tags: [],
                    owner : ""
                }
            ],
    ...
    getHabitControlData () : Array<Array<cardType>> {
        let cardData : Array<Array<cardType>> = [
            ...
            [
                {
                    text : "Gym Sessions 🙇" ,
                    description: "Get it running with the new training routine.",
                    tags: ['Sat', 'Tue', 'Frid'],
                    owner : ""
                },
                {
